...
public class SecondFighter extends Fighter {
    ...
    public SecondFighter(Vector2 Spawnlocation, Level level) {
        super(Spawnlocation,level,100,Constants.WORLD_SIZE / 3);
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        if (isGun)
            region = Assets.instance.fighter_2_assets.idle_gun;
        else
            region = Assets.instance.fighter_2_assets.idle_mgun;
        ...
        if (HEALTH<=0 && facing == Facing.RIGHT ) {
            ...
            region = Assets.instance.fighter_2_assets.Death_Animation.getKeyFrame(DeathTimeSeconds);
            right = true;
            left = false;
            ...
            if (facing == Facing.RIGHT && jumpState != JumpState.GROUNDED) {
                region = Assets.instance.fighter_2_assets.jumping;
                right = true;
                left = false;
                ...
                region = Assets.instance.fighter_2_assets.run_Animation.getKeyFrame(RunTimeSeconds);
                right = true;
                left = false;
